...
// armed-once seam this variant promotes to core.
//
...
// layeredPlane is two watchable planes composed on the read side alone: the
// first that holds an address answers.
//
// It is #361 written out. It implements no watch of its own, because
// [ferry.WatchAll] is what makes the composite watchable, and layering
// precedence is the only thing left for the caller to decide.
