...
func writeChartFooter(b *strings.Builder, th Theme, height float64) {
	...
	text(b, sideMargin, y+14, 10.5, "400", th.Muted, "start",
		"The allocation panel is linear and starts at zero. Generated by bench/cmd/perfreport from "+
			"benchstat output; no figure on this chart was typed.")
}
...
func writeRow(b *strings.Builder, r chartRow, th Theme, sec, alloc scale, y float64) {
	...
	text(b, sideMargin+13, mid+3.5, 11, "400", th.Text, "start", r.Impl)
