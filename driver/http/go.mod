module github.com/onhotpath/ferry/driver/http
...
// module's only import outside the standard library is core, and the two planes
// it reads are net/url's and net/http's own types, which every caller already
// has in hand.
