...
// it.
//
// The whole wiring is one expression: the file is named once, the conversion to
// a watchable source is on the value that already holds it, and the stream opens
// with a load. There is nothing to order and nothing to forget.
