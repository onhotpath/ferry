...
// countingLifecycle is a Source that records how often each phase of ADR-0004's
...
func (c *countingLifecycle) Bind(addrs *AddressSet) (OpenFunc, error) {
	c.binds.Add(1)
...
func TestABindingBindsOnce(t *testing.T) {
	...
	src := &countingLifecycle{src: planeSource{p: answering()}}
